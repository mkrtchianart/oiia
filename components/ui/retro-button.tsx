...
const retroButtonVariants = cva(
  "relative inline-flex items-center justify-center w-full h-[40px] border-2 border-transparent rounded-full",
  {
    variants: {
      variant: {
        lime: [
          "text-white",
          "w-[90vw]",
          "[--bg-color:theme(colors.lime.500)]",
          "[--bg-color-active:theme(colors.lime.600)]",
          "[--shadow-light:theme(colors.lime.300)]",
          "[--shadow-dark:theme(colors.lime.700)]",
        ],
        darkGray: [
          "text-white",
        ...
        blue: [
          ...
          "[--bg-color-active:theme(colors.blue.600)]",
          "[--shadow-light:theme(colors.blue.300)]",
          "[--shadow-dark:theme(colors.blue.700)]",
        ],
        gray: [
          "text-white",
